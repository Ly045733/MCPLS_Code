...
from networks.unet import UNet, UNet_DS, UNet_CCT, UNet_CCT_3H, UNet_EDGE, UNet_TRI, UNet_TRI_ATT
import os
...
def net_factory(net_type="unet", in_chns=1, class_num=3):
    ...
    elif net_type == "unet_edge":
        net = UNet_EDGE(in_chns=in_chns, class_num=class_num).cuda()
