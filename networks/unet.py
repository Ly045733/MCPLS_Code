...
class UNet_EDGE(nn.Module):
    def __init__(self, in_chns, class_num):
        ...
        self.encoder = Encoder(params)
        self.main_decoder = Decoder(params)
        self.aux_decoder1 = Decoder(params1)
...
class UNet_TRI_ATT(nn.Module):
    ...
    def forward(self, x):
        ...
        return main_seg, aux_seg1, aux_seg2,spatial_attention
  
    
class UNet_TRI_FUSION(nn.Module):
    def __init__(self, in_chns, class_num):
        super(UNet_TRI_FUSION, self).__init__()
    ...
    def forward(self, x):
        ...
        aux_seg1 = self.aux_decoder1(aux1_feature)
        aux1_feature = [Dropout(i) for i in feature]
        aux_seg2 = self.aux_decoder2(aux1_feature)
